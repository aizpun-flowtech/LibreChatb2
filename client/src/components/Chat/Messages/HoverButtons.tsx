...
const HoverButtons = ({
  ...
  return (
    <div className="group visible flex justify-center gap-0.5 self-end focus-within:outline-none lg:justify-start">
      ...
      {/* Feedback Buttons */}
      {!isCreatedByUser && (
        <Feedback handleFeedback={handleFeedback} feedback={message.feedback} isLast={isLast} message={message} conversation={conversation} />
      )}
      ...
      {!isCreatedByUser && customButtons?.map((button, i) => (
        <button
          key={i}
          className={cn(
